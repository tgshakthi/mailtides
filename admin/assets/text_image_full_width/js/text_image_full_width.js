...
$(document).ready(function () {
	$(function () {
		$("#background_image").observe_field(1, function () {
			var e = $("#image_url").val(),
				r = $("#httpUrl").val(),
				a = this.value.replace(e, "");
			$("#background_image").val(a);
			var t = a.replace(r + "/images/", "thumbs/");
			$("#image_preview3").attr("src", e + t).show(), 0 == t.length ? $("#image_preview4").attr("src", e + "images/noimage.png") : $("#image_preview4").attr("src", e + t)
		})
	})
