	...
	**/ 
	...
	var init = {
		...
		*/
		...
		loader : `<button class="cho-ose" type="button" data-id="no-sidebar"><img src="http://txgidocs.mailtides.com/admin/assets/email-blast/image/no-sidebar.jpg" class="img-responsive" alt=""><span>No Sidebar (wide)</span></button> <button class="choose" type="button" data-id="left-sidebar"><img src="http://txgidocs.mailtides.com/admin/assets/email-blast/image/left-sidebar.jpg" class="img-responsive" alt=""><span>Left Sidebar</span></button> <button class="cho-ose" type="button" data-id="right-sidebar"><img src="http://txgidocs.mailtides.com/admin/assets/email-blast/image/right-sidebar.jpg" class="img-responsive" alt=""><span>Right Sidebar</span></button> <button class="cho-ose" type="button" data-id="both-sidebar"><img src="http://txgidocs.mailtides.com/admin/assets/email-blast/image/both-sidebar.jpg" class="img-responsive" alt=""><span>Both Sidebars</span></button>`,
		/* Tooltips */
