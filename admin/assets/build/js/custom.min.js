...
function countChecked() {
	"all" === checkState && $(".bulk_action input#table_records").iCheck("check"), "none" === checkState && $(".bulk_action input#table_records").iCheck("uncheck");
	var a = $(".bulk_action input#table_records:checked").length;
...
function init_SmartWizard() {
	"undefined" != typeof $.fn.smartWizard && (console.log("init_SmartWizard"), $("#wizard_verticle").smartWizard({
