          			...
          			<div class="x_content">
            			...
            			<?php
              			...
              			echo form_open_multipart(
                			'testimonial/insert_update_testimonial_page',
              				...
              				<div class="x_panel">
                				<div class="x_content">
                                	...
                                	<div class="form-group">
                                        ...
                                        <?php
										echo form_label('Testimonial Per Row', 'testimonial_per_row');
										...
										echo form_dropdown($attributes, $options, $testimonial_per_row);
                                        ?>
                                    ...
                                    <!--<div class="form-group">
										...
										// Input tag
										$this->color->view($background_color, 'background_color', 2);
                                        ?>
                        ...
                        <div class="form-group" id="component-bg-color" <?php if ($component_background == 'color') :?>
                            ...
                            <?php
								...
								echo form_input(array(
									...
									'value' => $testimonial_background
								));
							?>
                            <div >
                                <?php									
									// Color
									$this->color->view($testimonial_background,'testimonial_background_color',4);
								?>
                            </div>
                        </div>
                            ...
                            <div class="img-thumbnail sepH_a" id="show_image1">
                                <?php
									if ($testimonial_background != '') :
										...
										$testmonial_img = $ImageUrl . 'images' . DIRECTORY_SEPARATOR . $website_folder_name . DIRECTORY_SEPARATOR . $testimonial_background;
										echo img(array(
												'src'   => $testmonial_img,
												'id'    => 'image_preview',
                              	...
                              	<div class="x_content">
                                	...
                                	<div class="cf nestable-lists">
                                    	<div class="dd" id="nestable">
                                        	<h3 class="heading">Testimonial List</h3>
                                          	<?php
                                            if (!empty($testimonials_unselected)) :
											  
                                            	echo '<ol class="dd-list">';
												  
												foreach ($testimonials_unselected as $testimonial_unselected) :
													
													if (!empty($testimonial_unselected->author)) :
														$unselected_sentence = $testimonial_unselected->author;
													else :
														$unselected_sentence = strip_tags($testimonial_unselected->content);
														$unselected_sentence = mb_strimwidth($unselected_sentence, 0, 80, "...");
													endif;
												  
                                                	echo '<li class="dd-item" data-id="'.$testimonial_unselected->id.'">
                                                    		<div class="dd-handle">
                                                            	'.$unselected_sentence.'
                                                          	</div>
                                                      	</li>';
                                      	...
                                      	<div class="dd" id="nestable2">
                                        	<h3 class="heading">Testimonial Page</h3>
                                            <?php
                                            if (!empty($testimonials_selected)) :
											  
                                            	echo '<ol class="dd-list">';
												  
												foreach ($testimonials_selected as $testimonial_selected) :
													
													if (!empty($testimonial_selected->author)) :
														$sentence = $testimonial_selected->author;
													else :
														$sentence = strip_tags($testimonial_selected->content);
														$sentence = mb_strimwidth($sentence, 0, 80, "...");
													endif;
												  
                                                	echo '<li class="dd-item" data-id="'.$testimonial_selected->id.'">
                                                    		<div class="dd-handle">
                                                            	'.$sentence.'
                                                          	</div>
														</li>';
