        ...
        <div class="">
          ...
          <div class="x_title">
            ...
            <div class="btn_right" style="text-align:right;">
				<?php
                    echo anchor(
                        'text_image_slider/text_image_slider_index/'.$page_id,
          ...
          <div class="x_content">
            ...
            <?php
              ...
              echo form_open_multipart(
                'text_image_slider/insert_update_text_image_slider',
              ...
              echo form_input(array(
                'type'  => 'hidden',
                'name'  => 'slider-image-id',
                'id'    => 'slider-image-id',
                'value' => $slider_image_id
              ));
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
					...
					<?php
                        ...
                        // label
                        echo form_label(
                            'Image <span class="required">* Recommended size(597*539)</span>',
                            'imgInp',
                        ...
                        <div class="img-thumbnail sepH_a" id="show_image1">
                            ...
                            if ($image != '') :
                                ...
                                $text_and_image_slider_img = $ImageUrl . 'images' . DIRECTORY_SEPARATOR . $website_folder_name . DIRECTORY_SEPARATOR . $image;

                                echo img(array(
                                    'src'   => $text_and_image_slider_img,
                                    'alt'   => $image_alt,
                                    'title' => $image_title,
                                    'id'    => 'image_preview',
