				...
				<div class="">
					...
					<div class="x_content">
						...
						<?php if ($page_status == '1') :?>
							...
							<form action="<?php echo base_url()?>email_blast/import_master_file" method="POST"
							...
							<form action="<?php echo base_url()?>email_blast/import_master_file" method="POST"
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									...
									<div class="input-button-group">
										...
										<a href="<?php echo base_url()?>email_blast/import_master_file" class="btn btn-primary" title="Back">Back</a>
