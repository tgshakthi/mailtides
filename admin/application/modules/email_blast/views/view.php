	...
	<div class="">
		<div class="page-title">
			...
			<div class="btn-right">	
				...
				<a href="<?php echo base_url();?>email_blast/import_master_file" class="btn btn-primary">
				...
				<a href="<?php echo base_url();?>email_blast/campaign_type" class="btn btn-info">
					<i class="fa fa-drumstick-bite" aria-hidden="true"></i> Campaign Type
				</a>

				<a href="<?php echo base_url();?>email_blast/campaign" class="btn btn-dark">
				...
				<a href="<?php echo base_url();?>email_blast/graphical_reports" class="btn btn-primary">
