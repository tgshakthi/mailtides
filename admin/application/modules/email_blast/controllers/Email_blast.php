...
class Email_blast extends MX_Controller
{
    ...
    function get_table_campaign_users()
    {
        ...
        foreach (($get_users ? $get_users : array()) as $get_user) {
            ...
            $this->table->add_row($i.' <input type="hidden"  id="email_balst_user" class="hidden-user-id" name="row_sort_order[]" value="' . $get_user->id . '">', $get_user->name, $get_user->email, $get_user->visited_date, $txgidocs, $google, $facebook);
