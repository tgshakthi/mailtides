    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <?php
						echo form_open(
						'text_background_image/delete_multiple_text_background_image',
          ...
          <div class="page_buut_right">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="text-align:right;">
              <?php
                echo anchor(
                  'text_background_image/add_edit_text_background_image/'.$page_id,
                  '<i class="fa fa-plus" aria-hidden="true"></i> Add Text Background Image',
                  array(
