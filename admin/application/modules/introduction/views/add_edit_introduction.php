                    ...
                    <div class="x_content">
                        ...
                        <?php
							...
							echo form_open_multipart(
								'introduction/insert_update_introduction',
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                        <?php
											echo form_label('Content <span class="required">*</span>','text');
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group" id="component-bg-color"
                                        ...
                                        <?php
											...
											echo form_input(array(
												'type'  => 'hidden',
												'name'  => 'introduction_background_color',
												'id'    => 'introduction_background_color',
												'value' => $introduction_background
											));
																			
												// Color
												$this->color->view($introduction_background,'introduction_background_color',4);
											?>
                                    ...
                                    <div class="form-group" id="component-bg-image"
                                        ...
                                        <div class="img-thumbnail sepH_a" id="show_image1">
                                            <?php
												if ($introduction_background != '') :

													$introduction_img = $ImageUrl . 'images' . DIRECTORY_SEPARATOR . $website_folder_name . DIRECTORY_SEPARATOR . $introduction_background;
													echo img(array(
