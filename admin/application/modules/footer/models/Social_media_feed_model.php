...
class Social_media_feed_model extends CI_Model
{
	 ...
	 */
	function get_footer_social_media_feed_setting($website_id, $code)
	{
		$this->db->select('*');
		$this->db->where(array(
	...
	/**
	 * insert and update footer_social_media_feed
	 * return output as stdClass Object array
	 */
	function insert_update_footer_social_media_feed($website_id, $id = NULL)
	{
		...
		if ($id == NULL):
			...
			$this->db->where(array('website_id' => $website_id, 'code' => 'footer_social_media_feed'));
