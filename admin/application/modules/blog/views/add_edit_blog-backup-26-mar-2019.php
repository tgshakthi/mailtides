                                        ...
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php
														echo form_label('Short Description','text2');
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php
														echo form_label('Description','text');
                                            ...
                                            <div class="x_content">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <?php									
															// Color
															$this->color->view($blog_background,'blog_detail_background_color',4);
														?>
                                                    </div>
                                                ...
                                                <div class="form-group" id="component-bg-color"
                                                    <?php if ($component_background == 'color') :?>
                                                    ...
                                                    <?php
														...
														echo form_input(array(
															'type'  => 'hidden',
															'name'  => 'blog_detail_background_color',
															'id'    => 'blog_detail_background_color',
															'value' => $blog_background
														));
													?>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="form-group" id="component-bg-image"
                                                    <?php if ($component_background == 'image') :?>
                                                    style="display:block;" <?php else : ?> style="display:none;"
                                                    <?php endif;?>>
