    ...
    <div class="row">
	  ...
	  <div class="col-md-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_title">
						...
						<?php
							echo heading('Text & Image Background', '2');
					...
					<div class="x_content">
						...
						<?php
							...
							// Form Tag
							  echo form_open(
								'text_image/insert_update_text_image_background',
                        ...
                        <div class="form-group" id="component-bg-color" <?php if ($component_background == 'color') :?>
                            ...
                            <?php
								...
								echo form_input(array(
									'type'  => 'hidden',
									'name'  => 'text_image_background_color',
									'id'    => 'text_image_background_color',
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php									
									// Color
									$this->color->view($text_image_background,'text_image_background_color',1);
								?>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="component-bg-image" <?php if ($component_background == 'image') :?>
                            ...
                            <div class="img-thumbnail sepH_a" id="show_image1">
                                <?php
									if ($text_image_background != '') :

										$text_img = $ImageUrl . 'images' . DIRECTORY_SEPARATOR . $website_folder_name . DIRECTORY_SEPARATOR . $text_image_background;
										echo img(array(
												'src'   => $text_img,
												'id'    => 'image_preview',
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <?php
						echo form_open(
						'text_image/delete_multiple_text_image',
          ...
          <div class="page_buut_right">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
							<?php
									...
									echo form_input(array(
										...
										'name'  => 'sort_url',
										'id'    => 'sort_url',
										'value' => base_url().'text_image/update_sort_order'
									));
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="text-align:right;">
              <?php
                echo anchor(
                  'text_image/add_edit_text_image/'.$page_id,
