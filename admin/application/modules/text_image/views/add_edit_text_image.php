        ...
        <div class="">
          ...
          <div class="x_title">
            ...
            <div class="btn_right" style="text-align:right;">
				<?php
                    echo anchor(
                        'text_image/text_image_index/'.$page_id,
          ...
          <div class="x_content">
            ...
            <?php
              ...
              echo form_open_multipart(
                'text_image/insert_update_text_image',
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="form-group">
						...
						<?php
                        echo form_label('Text <span class="required"> (Recommended 250 Characters Only)</span>','text');
            ...
            // Color
            if(!empty($content_title_color)):
              $this->color->view($content_title_color,'content-title-color',2);
            else:
              $this->color->view('black-text','content-title-color',2);
            endif;
                    ...
                    <div class="form-group">
                      ...
                      <?php
                        ...
                        if(!empty($content_color)):
                          ...
                          $this->color->view('black-text','content-color',3);
                        endif;
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                if(!empty($btn_background_color)):
                  ...
                  $this->color->view('white','btn_background_color',4);
                endif;
                ...
                if(!empty($label_color)):
                  ...
                  $this->color->view('black-text','label_color',5);
                endif;
                  ...
                  <div id="text_image_developer" style="display:none">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            if(!empty($background_hover)):
                              ...
                              $this->color->view('white','background_hover',6);
                            endif;
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            if(!empty($text_hover)):
                              ...
                              $this->color->view('black-text','text_hover',7);
                            endif;
                   ...
                   <!-- <div class="form-group ">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                            ...
                            // Input
                            echo form_input(array(
                                'id'      => 'readmore_character',
                                'name'    => 'readmore_character',
                                'class'   => 'form-control col-md-7 col-xs-12',
                                'value'   => $readmore_character
                            ));
                    	...
                    	<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                if(!empty($background_color)):
                                  $this->color->view($background_color,'background-color',9);
                                else:
                                  $this->color->view('white','background-color',9);
                                endif;
