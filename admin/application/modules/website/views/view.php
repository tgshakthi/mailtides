	...
	<div class="">
		...
		<div class="row">
            ...
            <?php endif; ?>
						...
						<?php
              echo form_open(
                'website/website/delete_selected_website',
            ...
            ?>
                ...
                ?>
							...
							<div class="col-md-6 col-sm-6 col-xs-6 col-md-offset-6 add_btn">
								<?php
                  echo anchor(
                    'website/website/add_edit_website',
                    'Add Website',
                    array(
