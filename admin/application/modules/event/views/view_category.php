...
<div class="right_col" role="main">
	...
	<div class="x_panel">
		...
		<div class="x_content">
			...
			<?php
				echo form_open(
					'event/delete_multiple_event_category',
			...
			<div class="page_buut_right">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
					...
					<?php
						...
						echo form_input(array(
							...
							'name'  => 'sort_url',
							'id'    => 'sort_url',
							'value' => base_url().'event/update_sort_order_category'
						));
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="text-align:right;">
					<?php
                    echo anchor(
                    	'event/add_edit_event_category',
                        '<i class="fa fa-plus" aria-hidden="true"></i> Add Event Category',
                        array(
