...
<div class="right_col" role="main">
  <div class="">
    <div class="page-title">
      ...
      <div class="btn_right" style="text-align:right;"> <a href="<?php echo base_url()?>email_blasts" class="btn btn-primary"><i class="fa fa-chevron-left"
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel"> 
          ...
          <div class="x_content">
            <div class="form-group">
              <label for="campaign_name" class="control-label col-md-3 col-sm-3 col-xs-12"> Select Campaign </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="hidden" name="website_id" id="website_id" value="<?php echo $website_id;?>">
                <input type="hidden" name="base_url" id="base_url" value="<?php echo base_url();?>">
