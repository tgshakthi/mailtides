				...
				<div class="">
					...
					<div class="x_content">
						...
						<?php if ($page_status == '1') :?>
							...
							<form action="<?php echo base_url()?>email_blasts/import_master_file" method="POST"
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									...
									<div class="input-button-group">
										...
										<a href="<?php echo base_url()?>email_blasts" class="btn btn-primary" title="Back">Back</a>
							...
							<form action="<?php echo base_url()?>email_blasts/import_master_file" method="POST"
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<select name="visited_date" id="visited-date" class="form-control col-md-7 col-xs-12" required="required">
														<?php foreach($csv_columns as $row){ ?>
														<option <?php echo $selected = (trim($row) == "Appoinment Date") ? "selected" : "";?> value="<?php echo trim($row); ?>"><?php echo trim($row); ?></option>
														<?php } ?>
													</select>													
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<select name="provider_name" id="provider-name" class="form-control col-md-7 col-xs-12" required="required">
														<?php foreach($csv_columns as $row) { ?>
														<option <?php echo $selected = (trim($row) == "Provider Name") ? "selected" : "";?> value="<?php echo trim($row); ?>"><?php echo trim($row); ?></option>
														<?php } ?>
													</select>													
												</div>
											</div>
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									...
									<div class="input-button-group">
										...
										<a href="<?php echo base_url()?>email_blasts/import_master_file" class="btn btn-primary" title="Back">Back</a>
