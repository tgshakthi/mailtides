			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="">
					...
					<div class="x_content">
						...
						<form action="<?php echo base_url()?>email_blasts/send_sms_import_data" method="POST"
								...
								<div class="x_panel">
									...
									<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <select name="campaign_type_name" class="form-control col-md-7 col-xs-12" id="campaign_type_name" required="required"  >
