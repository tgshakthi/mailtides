...
class Email_sms_blast_model extends CI_Model
{
	...
	private $column_search = array('name','email','facility_name','provider_name','phone_number','visited_date');
	private $column_order = array(null,'name','email','facility_name','provider_name','phone_number','visited_date');
	...
	function get_users_table($postData)
	{
	...
	function get_datatables_query($postData)
	{        
