	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="x_panel">
					<div class="x_content">
						<form action="<?php echo base_url()?>email_blasts/delete_multiple_campaign_category" id="form_selected_record"
							method="post">
							...
							<div class="page_buut_right">
								...
								<?php
								echo anchor(
									'email_sms_blast/add_edit_campaign_category',
									'<i class="fa fa-info-circle" aria-hidden="true"></i> Add Campaign Category',
									array(
										'class' => 'btn btn-info'
									)
								);					
