          ...
          <div class="x_content">
            ...
            <?php
              ...
              echo form_open_multipart(
                'conclusion/insert_update_conclusion',
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                	...
                	<div class="form-group">
					  ...
					  <?php
                      echo form_label('Title','conclusion-title');
                    ...
                    <div class="form-group">
					  ...
					  <?php
                      echo form_label('Conclusion <span class="required">*</span>','text');
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <?php
				  echo heading('Customize Title And Text', '2');
				  $list = array('<a class="collapse-link"><i class="fa fa-chevron-up"></i></a>');
				  $attributes = array('class' => 'nav navbar-right panel_toolbox');
				  echo ul($list,$attributes);
				  ?>
                ...
                <div class="x_content">
                    ...
                    <div class="form-group">
                      ...
                      // Color
                      $this->color->view($content_color,'content-color',2);
                      ?>
					...
					<div class="form-group" id="component-bg-color"
						...
						<?php
							...
							echo form_input(array(
								'type'  => 'hidden',
								'name'  => 'conclusion_background_color',
								'id'    => 'conclusion_background_color',
								'value' => $conclusion_background
							));
															
								// Color
								$this->color->view($conclusion_background,'conclusion_background_color',4);
							?>
					...
					<div class="form-group" id="component-bg-image" <?php if ($component_background == 'image') :?>
                            ...
                            <div class="img-thumbnail sepH_a" id="show_image1">
                                <?php
									if ($conclusion_background != '') :

										$conclusion_img = $ImageUrl . 'images' . DIRECTORY_SEPARATOR . $website_folder_name . DIRECTORY_SEPARATOR . $conclusion_background;
										echo img(array(
												'src'   => $conclusion_img,
												'id'    => 'image_preview',
