        ...
        <div class="">
          ...
          <div class="x_title">
            ...
            <div class="btn_right" style="text-align:right;">
				<?php
				echo anchor(
					'vertical_tab/vertical_tab_text_image/'.$page_id.'/'.$vertical_tab_id,
          ...
          <div class="x_content">
            ...
            <?php
              ...
              echo form_open_multipart(
                'vertical_tab/insert_update_vertical_tab_text_image',
                    ...
                    <div class="form-group">
                        ...
                        <div class="img-thumbnail sepH_a" id="show_image1">
                            ...
                            if ($image != '') :
                                ...
                                $vertical_tab_img = $ImageUrl . 'images' . DIRECTORY_SEPARATOR . $website_folder_name . DIRECTORY_SEPARATOR . $image;
                                echo img(array(
