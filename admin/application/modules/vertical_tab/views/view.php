    ...
    <div class="row">
				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<?php
							...
							// Form Tag
							  echo form_open(
								'vertical_tab/insert_update_vertical_tab_title',
                        ...
                        <div class="form-group" id="component-bg-color" <?php if ($component_background == 'color') :?>
                            ...
                            <?php
								...
								echo form_input(array(
									'type'  => 'hidden',
									'name'  => 'vertical_tab_background_color',
									'id'    => 'vertical_tab_background_color',
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php									
									// Color
									$this->color->view($vertical_tab_background,'vertical_tab_background_color',4);
								?>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="component-bg-image" <?php if ($component_background == 'image') :?>
                            ...
                            <div class="img-thumbnail sepH_a" id="show_image1">
                                <?php
									if ($vertical_tab_background != '') :

										$vertical_tab_img = $ImageUrl . 'images' . DIRECTORY_SEPARATOR . $website_folder_name . DIRECTORY_SEPARATOR . $vertical_tab_background;
										echo img(array(
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="input-button-group">
								<?php
									// Submit Button
									if (empty($vertical_tab_title_data)) :
										$submit_value = 'Add';
									else :
										$submit_value = 'Update';
									endif;
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <?php
						echo form_open(
						'vertical_tab/delete_multiple_vertical_tab',
          ...
          <div class="page_buut_right">
							...
							<?php
									...
									echo form_input(array(
										'type'  => 'hidden',
											'name'  => 'sort_url',
											'id'    => 'sort_url',
											'value' => base_url(). 'vertical_tab/update_sort_order'
									));
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="text-align:right;">
              <?php
                echo anchor(
                  'vertical_tab/add_edit_vertical_tab/'.$page_id,
                  '<i class="fa fa-plus" aria-hidden="true"></i> Add Vertical Tab',
                  array(
                    'class' => 'btn btn-success'
                  )
                );
