						...
						?>
                            ...
                            <div class="form-group">
								...
								echo form_input(array(
									...
									'name'  => 'title-color',
									'id'    => 'title-color',
									'value' => $map_title_color
								));
							?>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <?php
									// Input Tag
									$this->color->view($map_title_color,'title-color',1);
								?>
                                </div>
                            </div>
							...
							?>
                                <div class="col-md-9 col-sm-9 col-xs-12">
									...
									$attributes = array(
										'name'	=> 'map_title_position',
										'id'	=> 'map_title_position',
										'class'	=> 'form-control col-md-7 col-xs-12'
									);

									echo form_dropdown($attributes, $options, $map_title_position);
								?>
                                </div>
                            </div>
							...
							?>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
									...
									echo form_checkbox(array(
										'id'      => 'map_title_status',
										'name'    => 'map_title_status',
										'class'   => 'js-switch',
										'checked' => ($map_title_status === '1') ? TRUE : FALSE,
										'value'   => $map_title_status
									));
								?>
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
							...
							// Form Tag
              echo form_open(
                'map/insert_update_map_customize',
                'class="form-horizontal form-label-left" id="demo-form2" data-parsley-validate'
							);
                ...
                'value' => $page_id
						...
						<div class="form-group" id="component-bg-color" <?php if ($component_background == 'color') :?>
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <?php									
									// Color
									$this->color->view($map_background,'map_background_color',4);
								?>
                            </div>
                        </div>
                            ...
                            <div class="img-thumbnail sepH_a" id="show_image1">
                                <?php
									if ($map_background != '') :
										...
										$map_img = $ImageUrl . 'images' . DIRECTORY_SEPARATOR . $website_folder_name . DIRECTORY_SEPARATOR . $map_background;
										echo img(array(
												'src'   => $map_img,
												'id'    => 'image_preview',
					...
					?>
                        ...
                        <div class="page_buut_right">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="text-align:right;">
                                <?php
                echo anchor(
                  'map/add_edit_map/'.$page_id,
                  '<i class="fa fa-plus" aria-hidden="true"></i> Add Map',
                  array(
                    'class' => 'btn btn-success'
                  )
                );
