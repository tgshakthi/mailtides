<div class="palettefirst_color">
	...
	?>
    <div class="modal fade color_palette<?php echo $fnid ?>" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">			
                ...
                <div class="modal-body">
                	<div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <input type="text" id="search_color<?php echo $fnid ?>" onkeypress="return event.keyCode != 13;" onkeyup="search_colors(<?php echo $fnid ?>)" class="form-control" placeholder="Search color...">
                    </div>
                    <?php 
