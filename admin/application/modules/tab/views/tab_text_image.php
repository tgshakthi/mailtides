        ...
        <div class="">
          ...
          <div class="x_title">
            ...
            <div class="btn_right" style="text-align:right;">
				<?php
				echo anchor(
					'tab/tab_text_image/'.$page_id.'/'.$tab_id,
          ...
          <div class="x_content">
            ...
            <?php
              ...
              echo form_open_multipart(
                'tab/insert_update_tab_text_image',
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        // label
                        echo form_label(
                            'Image <span class="required">* Recommended (400*350)</span>',
                            'imgInp',
                        ...
                        <div class="img-thumbnail sepH_a" id="show_image1">
                            ...
                            if ($image != '') :
                                ...
                                $tab_text_image_img = $ImageUrl . 'images' . DIRECTORY_SEPARATOR . $website_folder_name . DIRECTORY_SEPARATOR . $image;
