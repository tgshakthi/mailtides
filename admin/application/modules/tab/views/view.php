                    ...
                    <!--    <div class="form-group">
                        ...
                        <div class="form-group" id="component-bg-color" <?php if ($component_background == 'color') :?>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php									
									// Color
									$this->color->view($tab_background,'tab_background_color',4);
								?>
                            </div>
                        </div>
                            ...
                            <div class="img-thumbnail sepH_a" id="show_image1">
                                <?php
									if ($tab_background != '') :
										...
										$tab_img = $ImageUrl . 'images' . DIRECTORY_SEPARATOR . $website_folder_name . DIRECTORY_SEPARATOR . $tab_background;
										echo img(array(
												'src'   => $tab_img,
												'id'    => 'image_preview',
							...
							<?php
									...
									echo form_input(array(
										'type'  => 'hidden',
											'name'  => 'sort_url',
											'id'    => 'sort_url',
											'value' => base_url(). 'tab/update_sort_order'
									));
