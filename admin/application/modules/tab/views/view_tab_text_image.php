      ...
      <div class="title_left">
        <?php echo heading($heading, '3');?>
			...
			<div class="btn_right" style="text-align:right;">
				<?php
					echo anchor(
						'tab/tab_component/'.$page_id.'/'.$tab_id,
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <?php
						echo form_open(
						'tab/delete_multiple_tab_text_image',
          ...
          <div class="page_buut_right">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
							<?php
									...
									// 		'name'  => 'sort_url',
									// 		'id'    => 'sort_url',
									// 		'value' => base_url(). 'tab/update_text_image_sort_order'
									// ));
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="text-align:right;">
              <?php
                echo anchor(
                  'tab/add_edit_tab_text_image/'.$page_id.'/'.$tab_id,
