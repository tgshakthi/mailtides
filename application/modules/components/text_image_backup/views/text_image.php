...
<section class="bg-img-common <?php echo $color_class;?>" style="background-image: url(http://softdash.joomlastars.co.in/softdash/images/2018/12/16/hero-bg.png)">
		 ...
		 <div class="text-and-image-content">
				<?php
					...
					echo heading(
						...
						5,
						array(
							'class' => $text_image->title_position. ' ' .$text_image->title_color .' h3-head'
						)
					);
				?>
