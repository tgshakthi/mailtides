...
<div class="common-space">
    <div class="container">
        <div class="blog_title">
                    ...
                    <div class="h1-head <?php echo $event_pages[0]->title_color.' '.$event_pages[0]->title_position;  ?>" data-aos="fadse-up">
                    <?php  echo strip_tags($event_pages[0]->title) ;?>
                    </div>
        </div>
...
<div class="event-overlay"></div>
                    ...
                    <div class="event-details">
                                        ...
                                        <div class="h5-head  <?php echo $event->title_color.' '.$event->title_position;?>" id="event_detail_heading"
                                        onmouseover = "eventDetailHeadHover('<?php echo$event->title_color ;?>', '<?php echo $event->title_hover_color;?>')" 
							            onmouseout = "eventDetailHeadHoverOut('<?php echo $event->title_color ;?>', '<?php echo $event->title_hover_color;?>')">
            ...
            <div id="event_masonry" class="row">
                ...
                <?php
                            ...
                            foreach($all_events as $all_event):
                                if(in_array($all_event->category_id,$category_id)):
                ...
                <div class=" col s12 m6 events-img-details <?php echo $event_pages[0]->event_per_row; ?>">
                    <a href="<?php echo base_url(); ?>event/<?php echo $all_event->event_url; ?>"
                        ...
                        onmouseover="eventGridHover('<?php echo $all_event->background_color; ?>',  '<?php echo $all_event->title_color; ?>', '<?php echo $all_event->title_hover_color; ?>', '<?php echo $all_event->short_description_title_color; ?>', '<?php echo $all_event->short_description_title_hover_color; ?>', '<?php echo $all_event->short_description_color; ?>', '<?php echo $all_event->short_description_hover_color; ?>', '<?php echo $all_event->date_color; ?>', '<?php echo $all_event->date_hover; ?>', '<?php echo $all_event->location_color; ?>', '<?php echo $all_event->location_hover; ?>', '<?php echo $page_id; ?>', '<?php echo $all_event->id; ?>')"
                        onmouseout="eventGridHoverOut('<?php echo $all_event->background_color; ?>',  '<?php echo $all_event->title_color; ?>', '<?php echo $all_event->title_hover_color; ?>', '<?php echo $all_event->short_description_title_color; ?>', '<?php echo $all_event->short_description_title_hover_color; ?>', '<?php echo $all_event->short_description_color; ?>', '<?php echo $all_event->short_description_hover_color; ?>', '<?php echo $all_event->date_color; ?>', '<?php echo $all_event->date_hover; ?>', '<?php echo $all_event->location_color; ?>', '<?php echo $all_event->location_hover; ?>', '<?php echo $page_id; ?>', '<?php echo $all_event->id; ?>')"
                        ...
                        <div class="event-details">
                                            ...
                                            <div class="h5-head"<?php echo $all_event->title_color.' '.$all_event->title_position ;?>id="<?php echo 'even_grid_title_'.$page_id.$all_event->id ;?>">
                                            <?php echo strip_tags($all_event->title);?>
                                            </div>
                            ...
                            <?php
                                            $heading_attributes = array(
                                             ...
                                             $heading_attribute='<div class="'.$all_event->short_description_title_color.' '.$all_event->short_description_title_position.'" id =" short_desc_title_'.$page_id.$all_event->id.'</div>';
            ...
            <div id="event_masonry" class="row">
                ...
                <div class=" events-img-details col s12 m6 <?php echo $event_pages[0]->event_per_row; ?>" data-aos="fade-up">
                    <a href="<?php echo base_url(); ?>event/<?php echo $events_by_category->event_url; ?>"
                        ...
                        <div class="event-details">
                                <div class="h5-head" <?php echo $events_by_category->title_color.' '.$events_by_category->title_position; ?> id="<?php echo 'even_grid_title_'.$page_id.$events_by_category->id;?>">
                                <?php echo  $events_by_category->title;?>
                                </div>
                            <ul class="event-date-detail">
