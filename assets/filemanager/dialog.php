...
if (isset($_GET['rootfldr']) && !empty($_GET['rootfldr'])) {
	$set_sub_folder_as_root = rawurldecode(trim(strip_tags($_GET['rootfldr']),"/"));
	$_SESSION['RF']['subfolder'] = $set_sub_folder_as_root;
}
