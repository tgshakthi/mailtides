...
! function(e, a, r) {
        ...
        R = {
            ...
            makeUploader: function() {
                jQuery("#fileupload").fileupload({
                    ...
                    a.formData = {
                        fldr: jQuery("#sub_folder").val() + jQuery("#fldr_value").val() + a.files[0].relativePath
                    }
    ...
    jQuery(document).ready(function() {
        ...
        if (jQuery("#full-img").on("click", function() {
            ...
            }), R.bindGridEvents(), parseInt(jQuery("#file_number").val()) > parseInt(jQuery("#file_number_limit_js").val())) var o = !1;
        else var o = !0;
        ...
        var n = jQuery("#callback").val(),
            ...
            l = (jQuery("#subdir").val(), jQuery("#base_url").val()),
        ...
        var c = "",
            s = ["ogg", "mp3", "wav"],
            d = ["mp4", "ogg", "webm"];
        if (1 == jQuery("#ftp").val()) var f = encodeURL(jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val() + a);
        else var p = jQuery("#return_relative_url").val(),
